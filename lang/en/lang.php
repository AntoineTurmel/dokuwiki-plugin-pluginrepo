...
$lang['t_typemusicvideo']    = '%s add-ons improve how Nightingale handle music and video.';
$lang['t_typelibrarypl']     = '%s add-ons improve browsing in Nightingale library and playlists making.';
$lang['t_typedeviceservices']= '%s add-ons add new way to discover music content on the web and manage devices.';
$lang['t_typewebbrowser']    = '%s add-ons improve the browsing experience in Nightingale Web Browser.';
$lang['t_typetools']         = '%s add-ons bring tools for developers to help contribute, test and build add-ons and feathers.';
$lang['t_typefeathers']      = '%s changes the look and feel of Nightingale';
